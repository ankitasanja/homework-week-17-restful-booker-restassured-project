...
public class BookingCRUDTest extends TestBaseBooking {
    ...
    public void test001() {
        ...
        Response response = requestSpecification.body(authPojo)
    ...
    public void test003() {
        ...
        System.out.println("Response printing ===== " + response.asString());
        newId = response.jsonPath().get("bookingid");
    ...
    public void test005() {
        ...
        Response response = requestSpecification.body(bookingPojo)
                .put("/" + newId);
